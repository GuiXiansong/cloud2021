...
//        String text = "http://guixiansongstudio.xyz";  //这里设置自定义网站url
        String text = "嗨喽，小帅哥";  //这里设置自定义网站url
        String logoPath = "C:\\Users\\lsxiansongg\\Pictures\\微信图片_师傅.jpg";
        String destPath = "E:\\images";
